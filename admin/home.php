...
<div class="row">
  ...
  <div class="col-12 col-sm-6 col-md-2">
    <div class="info-box mb-3">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">
          <?php
          $pending = $conn->query("SELECT count(id) AS count FROM `clients`")->fetch_assoc()['count'];
          echo number_format($pending);
          ?>
        </span>
      </div>
  ...
  <div class="col-12 col-sm-6 col-md-2">
    <div class="info-box mb-3">
      <span class="info-box-icon bg-yellow elevation-1"><i class="fas fa-microchip"></i></span>

      <div class="info-box-content">
        <span class="info-box-text">Brands List</span>
        <span class="info-box-number">
          <?php
          $pending = $conn->query("SELECT count(id) AS count FROM `brands`")->fetch_assoc()['count'];
          echo number_format($pending);
          ?>
        </span>
      </div>
  ...
  <div class="col-12 col-sm-6 col-md-2">
    <div class="info-box mb-3">
      <span class="info-box-icon bg-yellow elevation-1"><i class="fas fa-university"></i></span>

      <div class="info-box-content">
        <span class="info-box-text">Category List</span>
        <span class="info-box-number">
          <?php
          $pending = $conn->query("SELECT count(id) AS count FROM `categories`")->fetch_assoc()['count'];
          echo number_format($pending);
          ?>
        </span>
      </div>
