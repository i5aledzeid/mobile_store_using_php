	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <!--<div class="form-group">
				<label for="brand_id" class="control-label">Name</label>
			...
			<div class="form-group">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="fname" id="fname" class="form-control rounded-0" required value="<?php echo isset($name) ?$name : '' ?>" />
                    </div>
                    <div class="col">
                        <label for="name" class="control-label">Last Name</label>
                        <input type="text" name="lname" id="lname" class="form-control rounded-0" required value="<?php echo isset($name) ?$name : '' ?>" />
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="tel" name="contact" id="contact" class="form-control rounded-0" required value="<?php echo isset($name) ?$name : '' ?>" />
                    </div>
                    <div class="col">
                        <label for="name" class="control-label">Email</label>
                        <input type="email" name="email" id="email" class="form-control rounded-0" required value="<?php echo isset($name) ?$name : '' ?>" />
                    </div>
                    <div class="col">
                        <label for="name" class="control-label">Address</label>
                        <input type="text" name="address" id="address" class="form-control rounded-0" required value="<?php echo isset($name) ?$name : '' ?>" />
                    </div>
                </div>
            </div>
            <!--<div class="form-group">
